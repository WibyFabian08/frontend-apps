...
const Hero = () => {
  ...
  return (
    <>
      ...
      {/* <div className="pt-10 md:mx-auto lg:pt-20 bg-primary-600">
        <div className="container flex flex-col flex-wrap items-center justify-between h-full px-5 -mx-2 md:flex-row md:px-20">
          <div
            className="w-full px-2 mx-auto text-center lg:w-1/2"
            data-aos="fade-right"
          >
            <h2 className="text-3xl leading-tight text-white md:text-4xl">
              Lorem ipsum dolor emet <br />{" "}
          ...
          <div
            className="flex items-center justify-center w-full px-2 mt-10 lg:mt-0 lg:justify-end lg:w-1/2"
            data-aos="fade-left"
          >
            <div
              className="relative w-1/2 border border-white border-solid"
              style={{ height: "50vh" }}
            >
              <div
